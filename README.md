...
> 💜 Personal homepage and blog for **Hector Flores** ([@htekdev](https://github.com/htekdev)) 💻
> Built with ⚡ Astro 5 and deployed to 🌍 GitHub Pages at **[htek.dev](https://htek.dev)** 🎉

## ✨ Features 🎯

- 📝 **Blog / Articles** — Long-form technical writing on AI 🤖, developer tooling 🔧, and software architecture 🏗️
- 💼 **Consulting** — Enterprise consulting page with a 📅 Calendly booking embed
- 🎮 **3D Hero** — Interactive Three.js scene rendered as a ⚛️ React island
- 📡 **RSS Feed** — `/rss.xml` generated automatically from the articles collection
- 🔄 **Article Sync** — Automated cross-posting to DEV.to, Hashnode, and Medium via ⚙️ GitHub Actions
...
| 📦 Deployment | GitHub Pages via ⚙️ GitHub Actions (`deploy.yml`) |
...
```text
/
├── 🖼️  public/               # Static assets (images, fonts, favicon)
...
│   ├── layouts/          # 🖼️  Base page layout
│   ├── pages/            # 🗺️  Routes: index, /articles/*, /consulting, /rss.xml
...
# 🏗️ Production build (outputs to ./dist/)
npm run build
...
2. 🏷️ Add the required frontmatter:
...
Every 🔀 push to `main` triggers `.github/workflows/deploy.yml` ⚙️, which 🏗️ builds the site and publishes it to the `gh-pages` branch 🌿. GitHub Pages 🌍 serves from that branch at **[htek.dev](https://htek.dev)** 🎉.

---

🔥 Built with ☕ coffee, 💜 passion, and way too many 🌐 browser tabs by [@htekdev](https://github.com/htekdev) 🚀✨
