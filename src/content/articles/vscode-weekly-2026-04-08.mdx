...
VS Code 1.115 dropped this morning, hot on the heels of 1.114 last Tuesday. This weekly release cadence is wild, but what's more interesting is *what* they're shipping: the team is racing to make agentic workflows feel native, not bolted on.
...
Buried in 1.114 is the TypeScript 6.0 update. This is mostly bug fixes and stability improvements, but it also **deprecates older options** in preparation for the TypeScript 7.0 rewrite.
...
Read the [TypeScript 6.0 release notes](https://devblogs.microsoft.com/typescript/) for the full list of deprecated options.
...
The weekly cadence helps here. Small, focused releases let them experiment with agent workflows in production without shipping half-baked features in monthly milestones.
...
For individual developers, the takeaway is simpler: keep your VS Code updated. The weekly releases are stable, and the incremental improvements compound fast. The `#codebase` changes alone are worth updating for if you work in large repos.
