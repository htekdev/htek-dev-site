...
description: "v1.0.5 ships native PR workflows with /pr, CLI extension management, and multi-turn background agent conversations. The platform is maturing fast."
pubDate: 2026-03-13
