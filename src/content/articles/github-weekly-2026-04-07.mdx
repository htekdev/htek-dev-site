...
The SDK is available to all Copilot and non-Copilot subscribers, including Copilot Free users, and supports BYOK for enterprises. Each prompt counts toward your premium request quota.
